                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-3">
                                            @if (session("fecha_horario_m"))
                                                ...
                                                style="font-size: 1.6em; color:#1d59a7" class="form-control" value="{{session("fecha_horario_m")}}"> 
                                             @endif
                                        </div>
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3"></div>
                                        <div class="col-lg-6">
                                            <button type="submit" id="btnRemoverTurno" style="width: 16em;" class="btn btn-warning btn-lg mb-3 mt-5"><b>Remover este turno</b></button>
                                        </div>
                                        <div class="col-lg-3"></div>
